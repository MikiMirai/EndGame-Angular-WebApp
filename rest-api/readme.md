...
offers
.get /offers - lists all offers
.post /offers - create new offer only for registered users

posts:
.get offers/id - get all posts for offer
.post offers/id - create post in offer by id only for registered users
.put offers/id/posts/id - edit post only possible for author
.delete offers/id/posts/id - delete post only possible for author -->
...
<!--http://localhost:3000/api/offers -- {"title":"Some Offer", "_ownerId":"5f85bf709a517d36f4abe656", "post": "Some Post" } -->
<!-- http://localhost:3000/api/offers/5f858dd2d895ad23602db9d4  -- {"_ownerId":"5f8580d25d1da62568dd38fd", "postText": "Some Post textsdfasdf" } -->
